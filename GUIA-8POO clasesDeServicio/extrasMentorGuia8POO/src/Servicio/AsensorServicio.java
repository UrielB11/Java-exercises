...
yendo a un piso específico, y mostrando en pantalla el piso actual después de cada 
movimiento.
 */
package Servicio;

import Entidad.Asensor;


public class AsensorServicio {
    
    public void subir(Asensor x){
    x.setPisoActual(+1);
    }
