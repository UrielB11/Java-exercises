...
public class EjercicioExtra1 {
    ...
    public static void main(String[] args) {
        ...
        Raices raiz1= new Raices(4,40,1);
        
        rs.obtenerRaiz(raiz1);
        rs.obtenerRaices(raiz1);
        System.out.println(rs.tieneRaices(raiz1));
        System.out.println(rs.tieneRaiz(raiz1));
        System.out.println(rs.getDiscriminante(raiz1));
